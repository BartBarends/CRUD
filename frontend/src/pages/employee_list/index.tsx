        ...
        {employees.map(employee => {
          return <div className="row" key={employee.id}>
            ...
            <div className="actions">
                  <Link className="edit" to={"edit/" + employee.id}><FontAwesomeIcon icon={faPencilAlt} color="white" /></Link>
                  <p onClick={() => deleteEmployee(employee.id)} className="delete"><FontAwesomeIcon icon={faTrashAlt} color="white"/></p>
            </div>
          </div>
        })}
      </ul>
